...
| Step 4.2: alert + approval | ✅ | RFC `PENDING` + Gmail alert | [Alerts](EVIDENCE.md#notifications) |
...
| Step 3.1: success message | ✅ | `TABLE_SUCCESS` email | [Alerts](EVIDENCE.md#notifications) |
| Retry + alert on failure | ✅ | Retry ×3; `TABLE_FAILURE` email | [Run 6](EVIDENCE.md#live-runs) |
...
| Permissions to groups | ✅ | Roles assigned to groups only | [Key Vault IAM](EVIDENCE.md#identity-and-access) |
